...
import { useBoolean, useScrollPosition } from 'hooks-react-custom';
...
const Header: React.FC<HeaderProps> = (props) => {
  ...
  return (
    <>
      <header>
        <div className="h-[115px] bg-white z-[999] transition-all duration-150 fixed top-0 right-0 left-0">
